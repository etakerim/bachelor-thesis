...
sa uvažuje s intervalom $[-2^\frac{n}{2}; 2^\frac{n}{2} - 1]$. Digitálna hodnota v dvojkovom doplnku získaná konverziou
$\hat{x}$ je prepočítaná na štandardné fyzikálne jednotky pre zrýchlenie, na $m/s^2$. $R$ prestavuje nastavený
