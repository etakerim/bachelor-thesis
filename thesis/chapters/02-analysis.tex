...
agregácii načítaný bod $x_i$ zaráta do každého relevantného počítadla a môže byť ihneď zabudnutý \cite{data-streams}.
...
pre konkrétnu rozlíšiteľnosť spektra taktiež hovorí vzťah (\ref{equ:freq-resolution}). Rozpätie frekvencií spadajúcich do
