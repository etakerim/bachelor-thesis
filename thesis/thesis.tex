...
\nomenclature{\textbf{MQTT}}{Message Queuing Telemetry Transport (aplikačný protokol na prenos telemetrických údajov cez rady správ)}
...
\input{chapters/05-verification}
...
\input{chapters/appendix/A-plan-of-work}

\input{chapters/appendix/B-technical-docs}
\cleardoublepage

\input{chapters/appendix/C-user-manual}
\cleardoublepage

\input{chapters/appendix/D-digital-medium}
