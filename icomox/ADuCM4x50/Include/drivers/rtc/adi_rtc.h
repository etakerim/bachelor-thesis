...
#else
#define ADI_RTC_NUM_INTERRUPTS             18             /*!< Number of RTC interrupts. */
#endif
...
ADI_RTC_RESULT adi_rtc_SetAlarmRegs
              (ADI_RTC_HANDLE const  hDevice, 
              uint16_t nAlarm0,
              uint16_t nAlarm1,
              uint16_t nAlarm2);

ADI_RTC_RESULT adi_rtc_SetAlarmAsync(
               ADI_RTC_HANDLE const hDevice,
               uint32_t nAlarm
               );

ADI_RTC_RESULT adi_rtc_SetAlarmRegsAsync
              (ADI_RTC_HANDLE const  hDevice, 
              uint16_t nAlarm0,
              uint16_t nAlarm1,
              uint16_t nAlarm2);

ADI_RTC_RESULT adi_rtc_SyncAlarm(
               ADI_RTC_HANDLE const hDevice
               );
...
ADI_RTC_RESULT adi_rtc_SetAutoReloadValue(
                ...
                uint16_t nHighValue);
#else
#error "RTC driver not ported to this proccessor"
#endif               
...
ADI_RTC_RESULT adi_rtc_GetAlarmRegs(
               ADI_RTC_HANDLE hDevice, 
               uint16_t *pAlarm0,
               uint16_t *pAlarm1,
               uint16_t *pAlarm2);
...
ADI_RTC_RESULT adi_rtc_GetInputCaptureValueEx(
               ADI_RTC_HANDLE const hDevice,
               ADI_RTC_INPUT_CHANNEL eChannel,
               uint16_t *pSnap0, uint16_t * pSnap1, 
               uint16_t * pSnap2);
...
ADI_RTC_RESULT adi_rtc_GetISOENB(
               ADI_RTC_HANDLE const hDevice,
               uint16_t *pValue);
