...
/*! Set this macro to enable the DMA extended features. Data can be
    processed using DMA Pingpong and Scatter-Gather modes.
	0 - Disable the DMA extension. Only DMA Basic mode can be used.
	1 - Enable the DMA extension. DMA Basic, Pingpong and Scatter-Gather
        can be used.
