...
#define BITP_RTC_CR1_CNTMOD60ROLLINTEN        4            /*  Enable for the RTC Modulo-60 Count Roll-Over Interrupt Source */
...
#define BITM_RTC_CR1_CNTMOD60ROLLINTEN       (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  Enable for the RTC Modulo-60 Count Roll-Over Interrupt Source */
...
#define ENUM_WDT_STAT_COUNT_MATCH            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  COUNTING: APB and WDT clock domain CTRL values match */
#define ENUM_WDT_STAT_COUNT_SYNCING          (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  COUNTING: APB CTRL register values are being synchronized to WDT clock domain. */
#define ENUM_WDT_STAT_LOAD_MATCH             (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  LOADING: APB and WDT clock domains LOAD values match. */
#define ENUM_WDT_STAT_LOAD_SYNCING           (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  LOADING: APB LOAD value is being synchronized to WDT clock domain. */
...
#define ENUM_UART_ACR_EEC_EDGE1              (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  EEC: First edge */
#define ENUM_UART_ACR_EEC_EDGE2              (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  EEC: Second edge */
#define ENUM_UART_ACR_EEC_EDGE3              (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  EEC: Third edge */
#define ENUM_UART_ACR_EEC_EDGE4              (_ADI_MSK_3(0x00000300,0x00000300U, uint16_t  ))    /*  EEC: Fourth edge */
#define ENUM_UART_ACR_EEC_EDGE5              (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  EEC: Fifth edge */
#define ENUM_UART_ACR_EEC_EDGE6              (_ADI_MSK_3(0x00000500,0x00000500U, uint16_t  ))    /*  EEC: Sixth edge */
#define ENUM_UART_ACR_EEC_EDGE7              (_ADI_MSK_3(0x00000600,0x00000600U, uint16_t  ))    /*  EEC: Seventh edge */
#define ENUM_UART_ACR_EEC_EDGE8              (_ADI_MSK_3(0x00000700,0x00000700U, uint16_t  ))    /*  EEC: Eighth edge */
#define ENUM_UART_ACR_EEC_EDGE9              (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  EEC: Ninth edge */
#define ENUM_UART_ACR_SEC_EDGE1              (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  SEC: First edge */
#define ENUM_UART_ACR_SEC_EDGE2              (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  SEC: Second edge */
#define ENUM_UART_ACR_SEC_EDGE3              (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  SEC: Third edge */
#define ENUM_UART_ACR_SEC_EDGE4              (_ADI_MSK_3(0x00000030,0x00000030U, uint16_t  ))    /*  SEC: Fourth edge */
#define ENUM_UART_ACR_SEC_EDGE5              (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  SEC: Fifth edge */
#define ENUM_UART_ACR_SEC_EDGE6              (_ADI_MSK_3(0x00000050,0x00000050U, uint16_t  ))    /*  SEC: Sixth edge */
#define ENUM_UART_ACR_SEC_EDGE7              (_ADI_MSK_3(0x00000060,0x00000060U, uint16_t  ))    /*  SEC: Seventh edge */
#define ENUM_UART_ACR_SEC_EDGE8              (_ADI_MSK_3(0x00000070,0x00000070U, uint16_t  ))    /*  SEC: Eighth edge */
#define ENUM_UART_ACR_DIS_TIMEOUTINT         (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  TOIEN: Disable timeout interrupt */
#define ENUM_UART_ACR_EN_TIMEOUTINT          (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  TOIEN: Enable timeout interrupt */
#define ENUM_UART_ACR_DIS_DONEINT            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  DNIEN: Disable done interrupt */
#define ENUM_UART_ACR_EN_DONEINT             (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  DNIEN: Enable done interrupt */
#define ENUM_UART_ACR_DIS_AUTOBAUD           (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  ABE: Disable auto baudrate */
#define ENUM_UART_ACR_EN_AUTOBAUD            (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  ABE: Enable auto baudrate */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_ADC_CFG_VREFVBAT_DEL            10            /*  VRef VBAT delayed */
...
#define BITM_ADC_CFG_VREFVBAT_DEL            (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  VRef VBAT delayed */
...
#define BITP_ADC_CNV_CFG_DMAEN               13            /*  Enable DMA Channel */
#define BITP_ADC_CNV_CFG_AUTOMODE            12            /*  Enable Auto Mode */
...
#define BITP_ADC_CNV_CFG_BAT                  8            /*  Enable Battery Monitoring */
...
#define BITM_ADC_CNV_CFG_DMAEN               (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Enable DMA Channel */
#define BITM_ADC_CNV_CFG_AUTOMODE            (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Enable Auto Mode */
...
#define BITM_ADC_CNV_CFG_BAT                 (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Enable Battery Monitoring */
...
#define BITP_ADC_IRQ_EN_ALERT                12            /*  Enable Interrupt on Crossing Lower or Higher Limit */
...
#define BITM_ADC_IRQ_EN_ALERT                (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Enable Interrupt on Crossing Lower or Higher Limit */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_GPIO_DS_PIN15                   15            /*  Drive Strength Pin 15 */
#define BITP_GPIO_DS_PIN14                   14            /*  Drive Strength Pin 14 */
#define BITP_GPIO_DS_PIN13                   13            /*  Drive Strength Pin 13 */
#define BITP_GPIO_DS_PIN12                   12            /*  Drive Strength Pin 12 */
#define BITP_GPIO_DS_PIN11                   11            /*  Drive Strength Pin 11 */
#define BITP_GPIO_DS_PIN10                   10            /*  Drive Strength Pin 10 */
#define BITP_GPIO_DS_PIN09                    9            /*  Drive Strength Pin 09 */
#define BITP_GPIO_DS_PIN08                    8            /*  Drive Strength Pin 08 */
#define BITP_GPIO_DS_PIN07                    7            /*  Drive Strength Pin 07 */
#define BITP_GPIO_DS_PIN06                    6            /*  Drive Strength Pin 06 */
#define BITP_GPIO_DS_PIN05                    5            /*  Drive Strength Pin 05 */
#define BITP_GPIO_DS_PIN04                    4            /*  Drive Strength Pin 04 */
#define BITP_GPIO_DS_PIN03                    3            /*  Drive Strength Pin 03 */
#define BITP_GPIO_DS_PIN02                    2            /*  Drive Strength Pin 02 */
#define BITP_GPIO_DS_PIN01                    1            /*  Drive Strength Pin 01 */
#define BITP_GPIO_DS_PIN00                    0            /*  Drive Strength Pin 00 */
#define BITM_GPIO_DS_PIN15                   (_ADI_MSK_3(0x00008000,0x00008000U, uint16_t  ))    /*  Drive Strength Pin 15 */
#define BITM_GPIO_DS_PIN14                   (_ADI_MSK_3(0x00004000,0x00004000U, uint16_t  ))    /*  Drive Strength Pin 14 */
#define BITM_GPIO_DS_PIN13                   (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  Drive Strength Pin 13 */
#define BITM_GPIO_DS_PIN12                   (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  Drive Strength Pin 12 */
#define BITM_GPIO_DS_PIN11                   (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  Drive Strength Pin 11 */
#define BITM_GPIO_DS_PIN10                   (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  Drive Strength Pin 10 */
#define BITM_GPIO_DS_PIN09                   (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  Drive Strength Pin 09 */
#define BITM_GPIO_DS_PIN08                   (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  Drive Strength Pin 08 */
#define BITM_GPIO_DS_PIN07                   (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  Drive Strength Pin 07 */
#define BITM_GPIO_DS_PIN06                   (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  Drive Strength Pin 06 */
#define BITM_GPIO_DS_PIN05                   (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  Drive Strength Pin 05 */
#define BITM_GPIO_DS_PIN04                   (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  Drive Strength Pin 04 */
#define BITM_GPIO_DS_PIN03                   (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  Drive Strength Pin 03 */
#define BITM_GPIO_DS_PIN02                   (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  Drive Strength Pin 02 */
#define BITM_GPIO_DS_PIN01                   (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  Drive Strength Pin 01 */
#define BITM_GPIO_DS_PIN00                   (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  Drive Strength Pin 00 */
#define ENUM_GPIO_DS_SINGLE_PIN15            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN15: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN15            (_ADI_MSK_3(0x00008000,0x00008000U, uint16_t  ))    /*  PIN15: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN14            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN14: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN14            (_ADI_MSK_3(0x00004000,0x00004000U, uint16_t  ))    /*  PIN14: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN13            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN13: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN13            (_ADI_MSK_3(0x00002000,0x00002000U, uint16_t  ))    /*  PIN13: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN12            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN12: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN12            (_ADI_MSK_3(0x00001000,0x00001000U, uint16_t  ))    /*  PIN12: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN11            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN11: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN11            (_ADI_MSK_3(0x00000800,0x00000800U, uint16_t  ))    /*  PIN11: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN10            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN10: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN10            (_ADI_MSK_3(0x00000400,0x00000400U, uint16_t  ))    /*  PIN10: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN09            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN09: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN09            (_ADI_MSK_3(0x00000200,0x00000200U, uint16_t  ))    /*  PIN09: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN08            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN08: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN08            (_ADI_MSK_3(0x00000100,0x00000100U, uint16_t  ))    /*  PIN08: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN07            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN07: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN07            (_ADI_MSK_3(0x00000080,0x00000080U, uint16_t  ))    /*  PIN07: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN06            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN06: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN06            (_ADI_MSK_3(0x00000040,0x00000040U, uint16_t  ))    /*  PIN06: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN05            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN05: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN05            (_ADI_MSK_3(0x00000020,0x00000020U, uint16_t  ))    /*  PIN05: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN04            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN04: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN04            (_ADI_MSK_3(0x00000010,0x00000010U, uint16_t  ))    /*  PIN04: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN03            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN03: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN03            (_ADI_MSK_3(0x00000008,0x00000008U, uint16_t  ))    /*  PIN03: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN02            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN02: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN02            (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  PIN02: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN01            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN01: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN01            (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  PIN01: Double Drive Strength */
#define ENUM_GPIO_DS_SINGLE_PIN00            (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  PIN00: Single Drive Strength */
#define ENUM_GPIO_DS_DOUBLE_PIN00            (_ADI_MSK_3(0x00000001,0x00000001U, uint16_t  ))    /*  PIN00: Double Drive Strength */
...
#define BITP_SPORT_CTL_A_DATMUXSEL           22            /*  Data Multiplexer select */
...
#define BITM_SPORT_CTL_A_DATMUXSEL           (_ADI_MSK_3(0x00400000,0x00400000UL, uint32_t  ))    /*  Data Multiplexer select */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_SPORT_NUMTRAN_B_VALUE            0            /*  Number of transfers (Half SPORT B) */
#define BITM_SPORT_NUMTRAN_B_VALUE           (_ADI_MSK_3(0x00000FFF,0x00000FFFUL, uint32_t  ))    /*  Number of transfers (Half SPORT B) */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_CRYPT_KUWVALSTR1_INITIALVALUE0   0            /*  Initial Value */
#define BITM_CRYPT_KUWVALSTR1_INITIALVALUE0  (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  Initial Value */
...
#define REG_PMG0_PWRKEY                      0x4004C00C            /*  PMG0 Key Protection for PMG_PWRMOD and PMG_SRAMRET */
...
#define BITP_PMG_IEN_VREGOVR                  2            /*  Enable Interrupt When VREG Over Voltage (Above 1.32V) */
...
#define BITM_PMG_IEN_VREGOVR                 (_ADI_MSK_3(0x00000004,0x00000004UL, uint32_t  ))    /*  Enable Interrupt When VREG Over Voltage (Above 1.32V) */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_PMG_PWRMOD_MONVBATN              3            /*  Monitor VBAT During Hibernate Mode */
#define BITP_PMG_PWRMOD_MODE                  0            /*  Power Mode Bits */
#define BITM_PMG_PWRMOD_MONVBATN             (_ADI_MSK_3(0x00000008,0x00000008UL, uint32_t  ))    /*  Monitor VBAT During Hibernate Mode */
#define BITM_PMG_PWRMOD_MODE                 (_ADI_MSK_3(0x00000003,0x00000003UL, uint32_t  ))    /*  Power Mode Bits */
#define ENUM_PMG_PWRMOD_MONITOR_EN           (_ADI_MSK_3(0x00000000,0x00000000UL, uint32_t  ))    /*  MONVBATN: VBAT monitor enabled in PMG block */
#define ENUM_PMG_PWRMOD_MONITOR_DIS          (_ADI_MSK_3(0x00000008,0x00000008UL, uint32_t  ))    /*  MONVBATN: VBAT monitor disabled in PMG block */
...
#define BITP_XINT_CFG0_UART_RX_EN            20            /*  External Interrupt Using UART_RX Enable Bit */
#define BITP_XINT_CFG0_IRQ3EN                15            /*  External Interrupt 3 Enable */
#define BITP_XINT_CFG0_IRQ3MDE               12            /*  External Interrupt 3 Mode Registers */
#define BITP_XINT_CFG0_IRQ2EN                11            /*  External Interrupt 2 Enable */
#define BITP_XINT_CFG0_IRQ2MDE                8            /*  External Interrupt 2 Mode Registers */
#define BITP_XINT_CFG0_IRQ1EN                 7            /*  External Interrupt 1 Enable */
#define BITP_XINT_CFG0_IRQ1MDE                4            /*  External Interrupt 1 Mode Registers */
#define BITP_XINT_CFG0_IRQ0EN                 3            /*  External Interrupt 0 Enable */
...
#define BITM_XINT_CFG0_UART_RX_EN            (_ADI_MSK_3(0x00100000,0x00100000UL, uint32_t  ))    /*  External Interrupt Using UART_RX Enable Bit */
#define BITM_XINT_CFG0_IRQ3EN                (_ADI_MSK_3(0x00008000,0x00008000UL, uint32_t  ))    /*  External Interrupt 3 Enable */
#define BITM_XINT_CFG0_IRQ3MDE               (_ADI_MSK_3(0x00007000,0x00007000UL, uint32_t  ))    /*  External Interrupt 3 Mode Registers */
#define BITM_XINT_CFG0_IRQ2EN                (_ADI_MSK_3(0x00000800,0x00000800UL, uint32_t  ))    /*  External Interrupt 2 Enable */
#define BITM_XINT_CFG0_IRQ2MDE               (_ADI_MSK_3(0x00000700,0x00000700UL, uint32_t  ))    /*  External Interrupt 2 Mode Registers */
#define BITM_XINT_CFG0_IRQ1EN                (_ADI_MSK_3(0x00000080,0x00000080UL, uint32_t  ))    /*  External Interrupt 1 Enable */
#define BITM_XINT_CFG0_IRQ1MDE               (_ADI_MSK_3(0x00000070,0x00000070UL, uint32_t  ))    /*  External Interrupt 1 Mode Registers */
#define BITM_XINT_CFG0_IRQ0EN                (_ADI_MSK_3(0x00000008,0x00000008UL, uint32_t  ))    /*  External Interrupt 0 Enable */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_PMG_TST_SRAM_CTL_INSTREN        31            /*  Enables 32kB Instruction SRAM */
...
#define BITP_PMG_TST_SRAM_CTL_STARTINIT      13            /*  Start Manual Initialization */
...
#define BITM_PMG_TST_SRAM_CTL_INSTREN        (_ADI_MSK_3(0x80000000,0x80000000UL, uint32_t  ))    /*  Enables 32kB Instruction SRAM */
...
#define BITM_PMG_TST_SRAM_CTL_STARTINIT      (_ADI_MSK_3(0x00002000,0x00002000UL, uint32_t  ))    /*  Start Manual Initialization */
...
/* -------------------------------------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_PMG_TST_CLR_LATCH_GPIOS_VALUE    0            /*  Clear the Latches for GPIOs */
#define BITM_PMG_TST_CLR_LATCH_GPIOS_VALUE   (_ADI_MSK_3(0x0000FFFF,0x0000FFFFU, uint16_t  ))    /*  Clear the Latches for GPIOs */
...
#define ENUM_PMG_TST_FAST_SHT_WAKEUP_FASTWAKE_DIS (_ADI_MSK_3(0x00000000,0x00000000UL, uint32_t  ))    /*  FAST_SHT_WAKEUP: Fast shutdown wakeup is disabled */
#define ENUM_PMG_TST_FAST_SHT_WAKEUP_FASTWAKE_EN (_ADI_MSK_3(0x00000001,0x00000001UL, uint32_t  ))    /*  FAST_SHT_WAKEUP: Fast shutdown wakeup is enabled */
...
#define ENUM_CLKG_CLK_CTL0_PLL_HFOSC         (_ADI_MSK_3(0x00000000,0x00000000UL, uint32_t  ))    /*  PLL_IPSEL: Internal HF oscillator is selected */
#define ENUM_CLKG_CLK_CTL0_PLL_HFXTAL        (_ADI_MSK_3(0x00000800,0x00000800UL, uint32_t  ))    /*  PLL_IPSEL: External HF XTAL oscillator is selected */
#define ENUM_CLKG_CLK_CTL0_PLL_GPIO          (_ADI_MSK_3(0x00001000,0x00001000UL, uint32_t  ))    /*  PLL_IPSEL: GPIO_CLK input is selected */
#define ENUM_CLKG_CLK_CTL0_PLL_GPIO1         (_ADI_MSK_3(0x00001800,0x00001800UL, uint32_t  ))    /*  PLL_IPSEL: GPIO_CLK input is selected */
...
#define REG_BUSM0_ARBIT1                     0x4004C804            /*  BUSM0 Arbitration Priority Configuration for SRAM1 */
...
#define REG_NVIC0_INTSETE2                   0xE000E108            /*  NVIC0 IRQ64..95 Set_Enable */
...
#define REG_NVIC0_INTCLRE2                   0xE000E188            /*  NVIC0 IRQ64..95 Clear_Enable */
...
#define REG_NVIC0_INTSETP2                   0xE000E208            /*  NVIC0 IRQ64..95 Set_Pending */
...
#define REG_NVIC0_INTCLRP2                   0xE000E288            /*  NVIC0 IRQ64..95 Clear_Pending */
...
#define REG_NVIC0_INTACT2                    0xE000E308            /*  NVIC0 IRQ64..95 Active Bit */
...
#define REG_NVIC0_INTPRI11                   0xE000E42C            /*  NVIC0 IRQ44..47 Priority */
#define REG_NVIC0_INTPRI12                   0xE000E430            /*  NVIC0 IRQ48..51 Priority */
#define REG_NVIC0_INTPRI13                   0xE000E434            /*  NVIC0 IRQ52..55 Priority */
#define REG_NVIC0_INTPRI14                   0xE000E438            /*  NVIC0 IRQ56..59 Priority */
#define REG_NVIC0_INTPRI15                   0xE000E43C            /*  NVIC0 IRQ60..63 Priority */
#define REG_NVIC0_INTPRI16                   0xE000E440            /*  NVIC0 IRQ64..67 Priority */
#define REG_NVIC0_INTPRI17                   0xE000E444            /*  NVIC0 IRQ68..71 Priority */
...
/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTSETE2                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTSETE2_VALUE              0            /*  IRQ64..95 Set_Enable */
#define BITM_NVIC_INTSETE2_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ64..95 Set_Enable */
...
/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTCLRE2                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTCLRE2_VALUE              0            /*  IRQ64..95 Clear_Enable */
#define BITM_NVIC_INTCLRE2_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ64..95 Clear_Enable */
...
/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTSETP2                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTSETP2_VALUE              0            /*  IRQ64..95 Set_Pending */
#define BITM_NVIC_INTSETP2_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ64..95 Set_Pending */
...
/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTCLRP2                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTCLRP2_VALUE              0            /*  IRQ64..95 Clear_Pending */
#define BITM_NVIC_INTCLRP2_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ64..95 Clear_Pending */
...
/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTACT2                         Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTACT2_VALUE               0            /*  IRQ64..95 Active Bit */
#define BITM_NVIC_INTACT2_VALUE              (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ64..95 Active Bit */
...
/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI11                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI11_VALUE              0            /*  IRQ44..47 Priority */
#define BITM_NVIC_INTPRI11_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ44..47 Priority */

/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI12                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI12_VALUE              0            /*  IRQ48..51 Priority */
#define BITM_NVIC_INTPRI12_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ48..51 Priority */

/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI13                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI13_VALUE              0            /*  IRQ52..55 Priority */
#define BITM_NVIC_INTPRI13_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ52..55 Priority */

/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI14                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI14_VALUE              0            /*  IRQ56..59 Priority */
#define BITM_NVIC_INTPRI14_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ56..59 Priority */

/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI15                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI15_VALUE              0            /*  IRQ60..63 Priority */
#define BITM_NVIC_INTPRI15_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ60..63 Priority */

/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI16                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI16_VALUE              0            /*  IRQ64..67 Priority */
#define BITM_NVIC_INTPRI16_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ64..67 Priority */

/* -------------------------------------------------------------------------------------------------------------------------
          NVIC_INTPRI17                        Pos/Masks         Description
   ------------------------------------------------------------------------------------------------------------------------- */
#define BITP_NVIC_INTPRI17_VALUE              0            /*  IRQ68..71 Priority */
#define BITM_NVIC_INTPRI17_VALUE             (_ADI_MSK_3(0xFFFFFFFF,0xFFFFFFFFUL, uint32_t  ))    /*  IRQ68..71 Priority */
...
#define ENUM_NVIC_INTCON0_NO_SLEEPDEEP       (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  SLEEPDEEP: Sleep Deep is not enabled */
#define ENUM_NVIC_INTCON0_SLEEPDEEP          (_ADI_MSK_3(0x00000004,0x00000004U, uint16_t  ))    /*  SLEEPDEEP: Sleep Deep is enabled */
#define ENUM_NVIC_INTCON0_NO_SLEEPONEXIT     (_ADI_MSK_3(0x00000000,0x00000000U, uint16_t  ))    /*  SLEEPONEXIT: Sleep On Exit is not enabled */
#define ENUM_NVIC_INTCON0_SLEEPONEXIT        (_ADI_MSK_3(0x00000002,0x00000002U, uint16_t  ))    /*  SLEEPONEXIT: Sleep On Exit is enabled */
