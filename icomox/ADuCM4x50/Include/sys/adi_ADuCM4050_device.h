...
/** @defgroup UART Universal Asynchronous Receiver/Transmitter (UART) Module
...
/** @defgroup ADC Digital Controller for ADC (ADC) Module
 ...
 *  \brief  Digital Controller for ADC
 *  ========================================================================== */
...
/** @defgroup GPIO General-Purpose Input/Output (GPIO) Module
...
typedef struct _ADI_CRYPT_TypeDef
{
    ...
    __I __C  uint32_t   SHAH0;                         /*!< SHA Bits [31:0] */
    __I __C  uint32_t   SHAH1;                         /*!< SHA Bits [63:32] */
    __I __C  uint32_t   SHAH2;                         /*!< SHA Bits [95:64] */
    __I __C  uint32_t   SHAH3;                         /*!< SHA Bits [127:96] */
    __I __C  uint32_t   SHAH4;                         /*!< SHA Bits [159:128] */
    __I __C  uint32_t   SHAH5;                         /*!< SHA Bits [191:160] */
    __I __C  uint32_t   SHAH6;                         /*!< SHA Bits [223:192] */
    __I __C  uint32_t   SHAH7;                         /*!< SHA Bits [255:224] */
...
typedef struct _ADI_PMG_TypeDef
{
    ...
    __O      uint32_t   PWRKEY;                        /*!< Key Protection for PMG_PWRMOD and PMG_SRAMRET */
...
typedef struct _ADI_BUSM_TypeDef
{
    ...
    __IO     uint32_t   ARBIT1;                        /*!< Arbitration Priority Configuration for SRAM1 */
...
/** @defgroup NVIC Cortex Interrupt Controller (NVIC) Module
 ...
 *  \brief  Cortex Interrupt Controller
 *  ========================================================================== */
...
typedef struct _ADI_NVIC_TypeDef
{
    ...
    __IO     uint32_t   INTSETE2;                      /*!< IRQ64..95 Set_Enable */
    __I __C  uint8_t  RESERVED3[116];
    __IO     uint32_t   INTCLRE0;                      /*!< IRQ0..31 Clear_Enable */
    __IO     uint32_t   INTCLRE1;                      /*!< IRQ32..63 Clear_Enable */
    __IO     uint32_t   INTCLRE2;                      /*!< IRQ64..95 Clear_Enable */
    __I __C  uint8_t  RESERVED4[116];
    __IO     uint32_t   INTSETP0;                      /*!< IRQ0..31 Set_Pending */
    __IO     uint32_t   INTSETP1;                      /*!< IRQ32..63 Set_Pending */
    __IO     uint32_t   INTSETP2;                      /*!< IRQ64..95 Set_Pending */
    __I __C  uint8_t  RESERVED5[116];
    __IO     uint32_t   INTCLRP0;                      /*!< IRQ0..31 Clear_Pending */
    __IO     uint32_t   INTCLRP1;                      /*!< IRQ32..63 Clear_Pending */
    __IO     uint32_t   INTCLRP2;                      /*!< IRQ64..95 Clear_Pending */
    __I __C  uint8_t  RESERVED6[116];
    __IO     uint32_t   INTACT0;                       /*!< IRQ0..31 Active Bit */
    __IO     uint32_t   INTACT1;                       /*!< IRQ32..63 Active Bit */
    __IO     uint32_t   INTACT2;                       /*!< IRQ64..95 Active Bit */
    __I __C  uint8_t  RESERVED7[244];
    ...
    __IO     uint32_t   INTPRI11;                      /*!< IRQ44..47 Priority */
    __IO     uint32_t   INTPRI12;                      /*!< IRQ48..51 Priority */
    __IO     uint32_t   INTPRI13;                      /*!< IRQ52..55 Priority */
    __IO     uint32_t   INTPRI14;                      /*!< IRQ56..59 Priority */
    __IO     uint32_t   INTPRI15;                      /*!< IRQ60..63 Priority */
    __IO     uint32_t   INTPRI16;                      /*!< IRQ64..67 Priority */
    __IO     uint32_t   INTPRI17;                      /*!< IRQ68..71 Priority */
    __I __C  uint8_t  RESERVED8[2232];
...
#define pADI_UART0                     ((ADI_UART_TypeDef     *) ADI_UART0_BASE      ) /*!<  Pointer to Universal Asynchronous Receiver/Transmitter (UART0) */
#define pADI_UART1                     ((ADI_UART_TypeDef     *) ADI_UART1_BASE      ) /*!<  Pointer to Universal Asynchronous Receiver/Transmitter (UART1) */
#define pADI_BEEP0                     ((ADI_BEEP_TypeDef     *) ADI_BEEP0_BASE      ) /*!<  Pointer to Beeper Driver (BEEP0) */
#define pADI_ADC0                      ((ADI_ADC_TypeDef      *) ADI_ADC0_BASE       ) /*!<  Pointer to Digital Controller for ADC (ADC0) */
...
#define pADI_GPIO0                     ((ADI_GPIO_TypeDef     *) ADI_GPIO0_BASE      ) /*!<  Pointer to General-Purpose Input/Output (GPIO0) */
#define pADI_GPIO1                     ((ADI_GPIO_TypeDef     *) ADI_GPIO1_BASE      ) /*!<  Pointer to General-Purpose Input/Output (GPIO1) */
#define pADI_GPIO2                     ((ADI_GPIO_TypeDef     *) ADI_GPIO2_BASE      ) /*!<  Pointer to General-Purpose Input/Output (GPIO2) */
#define pADI_GPIO3                     ((ADI_GPIO_TypeDef     *) ADI_GPIO3_BASE      ) /*!<  Pointer to General-Purpose Input/Output (GPIO3) */
...
#define pADI_NVIC0                     ((ADI_NVIC_TypeDef     *) ADI_NVIC0_BASE      ) /*!<  Pointer to Cortex Interrupt Controller (NVIC0) */
