 ...
 *
 * @details  Set the acquisition time of ADC in ADC clock cycles.
 *           The acquisition phase is (ADC_CNV_TIME.SAMPTIME + 1) ACLK cycles
 *
 * @param [in] hDevice               Handle to the device instance
 *
 ...
 *           - #ADI_ADC_BUFFER_OVERFLOW             If data has not been read before next conversion then that data is overwritten and an overflow error occurs.  
 *           - #ADI_ADC_INVALID_DEVICE_HANDLE   [D] Invalid device handle passed to the API 
